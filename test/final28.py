...
def imp(raw):
    ...
    b1.place(x=30,y=130)
    b2 = Button(root1, text = "Tail (!)      ", command = lambda:tail(html_tag,'tail',1),font=("Times", "18"))
    b2.place(x=30,y=50)
    b3 = Button(root1, text = "Head (&)  ", command =  lambda:head(html_tag,'head',1),font=("Times", "18"))
    b3.place(x=30,y=90)
